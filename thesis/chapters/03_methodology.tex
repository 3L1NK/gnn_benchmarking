...
\begin{itemize}
  ...
  \item graph-feature baselines: \texttt{xgb\_node2vec\_corr}, \texttt{graphlasso\_linear},
...
Graphical Lasso linear smoothing is included in the canonical tuned matrix as a graph-feature baseline with explicit regularization parameter $\alpha$ and train-window fitting only.
